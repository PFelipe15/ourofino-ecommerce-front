            ...
            {loading ? (
              ...
              productsList && productsList.length > 0 ? productsList?.map((product, index) => (
                ...
                <div className="col-span-full text-center py-12">
                  ...
                  <p className="mt-1 text-sm text-gray-500">Desculpe, não encontramos produtos com os filtros atuais.</p>
                  <div className="mt-6">
                    <button
                      type="button"
                      className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-primary hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500"
                      onClick={() => {
                        // Função para resetar os filtros
                        setFilters(getFiltersFromURL());
                        updateURL(getFiltersFromURL());
                      }}
                    >
                      Limpar filtros
                    </button>
